...
<body>
    ...
    <div class="container">
        <h1 class="page-title">入出荷記録登録</h1>
        <div class="card">
            <?php if (!empty($error)): ?>
                <p class="error-message"><?= h($error) ?></p>
            <?php endif; ?>
            <form action="./movement_new.php" method="post" id="new-form">
            ...
            <div class="form-actions">
                <button type="submit" form="new-form" class="submit-btn">登録</button>
